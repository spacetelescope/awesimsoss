...
def trace_from_webbpsf(psf_file, offset=100):
    """
...
def distance_map(order, coeffs='', dims=(256,2048), start=4, end=2044, plot=True):
    """
    ...
    """
    TODO: GET THE DEFAULT POLYNOMIAL COEFFS FOR THE TRACE FROM THE ORDER MASKS
    """
    # If coefficients are provided, generate a new map
    if isinstance(coeffs, (list, tuple, np.ndarray)):
...
def generate_psf(filt, wavelength='', oversample=4, to1D=False, plot=False):
    """
