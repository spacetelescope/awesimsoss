...
PACKAGENAME = metadata.get('package_name', 'AWESim_SOSS')
DESCRIPTION = metadata.get('description', 'Analyzing Webb Exoplanet Simulations with SOSS')
AUTHOR = metadata.get('author', 'Joseph Filippazzo and Jonathan Fraine')
AUTHOR_EMAIL = metadata.get('author_email', 'jfilippazzo@stsci.edu')
LICENSE = metadata.get('license', 'MIT')
URL = metadata.get('url', 'https://github.com/ExoCTK/AWESim_SOSS')
...
#   (4) package docstring
readme_glob = 'README*'
_cfg_long_description = metadata.get('long_description', 'JWST NIRISS SOSS Exoplanet Spectroscopic Simulator')
