...
PACKAGENAME = metadata.get('package_name', 'awesimsoss')
DESCRIPTION = metadata.get('description', 'awesimsoss is a TSO simulator for the SOSS mode of the NIRISS instrument onboard the JWST')
AUTHOR = metadata.get('author', 'Joe Filippazzo and Jonathan Fraine')
AUTHOR_EMAIL = metadata.get('author_email', 'jfilippazzo@stsci.edu')
LICENSE = metadata.get('license', 'MIT')
URL = metadata.get('url', 'https://github.com/spacetelescope/awesimsoss')
__minimum_python_version__ = metadata.get("minimum_python_version", "3.4")

# Enforce Python version check - this is the same check as in __init__.py but
# this one has to happen before importing ah_bootstrap.
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: awesimsoss requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
